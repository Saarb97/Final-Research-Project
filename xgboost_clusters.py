...
def train_with_smote_kfold(X, y):
    ...
    for train_index, test_index in kf.split(X, y):
        ...
        minority_auc_scorer = make_scorer(roc_auc_score_minority, needs_proba=True)
    ...
    return avg_accuracy, avg_roc_auc_0, avg_roc_auc_1, reports, feature_importances
...
def summarize_results_kfold(i, avg_accuracy, avg_roc_auc_0, avg_roc_auc_1, reports):
...
def main_kfold():
    ...
    for i in range(20):  # Loop from 0_data.csv to 19_data.csv
        ...
        avg_accuracy, avg_roc_auc_0, avg_roc_auc_1, reports, feature_importances = train_with_smote_kfold(X, y)
        result = summarize_results_kfold(i, avg_accuracy, avg_roc_auc_0, avg_roc_auc_1, reports)
